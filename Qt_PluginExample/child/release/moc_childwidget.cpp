...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ChildWidget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ChildWidget_t qt_meta_stringdata_ChildWidget = {
    {
QT_MOC_LITERAL(0, 11) // "ChildWidget"
...
const QMetaObject ChildWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ChildWidget.offsetsAndSize,
    qt_meta_data_ChildWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ChildWidget_t
, QtPrivate::TypeAndForceComplete<ChildWidget, std::true_type>
